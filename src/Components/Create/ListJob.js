...
function ListJob(props) {
  ...
  const fetchData = async () => {
    try {
      const response = await api.get(`/api/job-admin`);
      if (response) {
        ...
        setListJob((state) => response.data.listJob);
      }
    } catch (error) {
      setIsLoading(false);
                      ...
                      <thead className="datatable-head">
                        ...
                        >
                          ...
                          <th
                            ...
                            style={{ width: "15%" }}
                          >
                            <span style={{ width: "" }}>Salary Range</span>
                          </th>
                          <th
                            data-field="Type"
                            data-autohide-disabled="false"
