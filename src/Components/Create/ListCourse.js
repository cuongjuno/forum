...
function ListCourse(props) {
  ...
  const submitDestroy = async (id , is_show ) => {
    try {
      const res = await api.patch("/api/course", {
        id: id,
        is_show: !is_show,
      });
       await  fetchData();
  ...
  const fetchData = async () => {
    try {
      const response = await api.get(`/api/course-admin`);
      if (response) {
        setListCourse((state) => response.data.listCourse);
      }
    } catch (error) {
      setIsLoading(false);
              ...
              <div className="d-flex align-items-center mr-1">
                <div className="d-flex align-items-baseline flex-wrap mr-5">
                  <ul className="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold my-2 p-0">
                    ...
                    <li className="breadcrumb-item">
                      <div className="text-dark">List Course</div>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="card card-custom">
                <div className="card-header flex-wrap border-0 pt-6 pb-0">
                  <div className="card-title">
                    <h3 className="card-label">List Course</h3>
                  </div>
                      ...
                      <thead className="datatable-head">
                        ...
                        >
                          ...
                          <th
                            ...
                            style={{ width: "15%" }}
                          >
                            <span style={{ width: "" }}>Name Course</span>
                          </th>
                          ...
                          <th
                            ...
                            style={{ width: "15%" }}
                          >
                            <span style={{ width: "" }}>Expecting Open</span>
                          </th>
                                  ...
                                  <span>
                                    <span className="switch switch-outline switch-icon switch-primary">
                                      ...
                                      >
                                        <input
                                          type="checkbox"
                                          checked={course.is_show}
                                          name="isShow"
                                          onChange={() =>
                                            {
                                              setMystate([course.id , course.is_show])
                                              handleOpen()
                                            }
                                          }
                                        />
